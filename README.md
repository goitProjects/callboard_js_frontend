...
Если не отображаются объявления, отключите addblocker для этого сайта у себя в браузере и перезагрузите страницу. Деплой сделан из ветки master и раздается из ветки gh-pages данного репозитория.
